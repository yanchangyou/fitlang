...
public class ConvertJsonExecuteNodeTest extends TestCase {
    ...
    public void test() {
        ...
        for (JSONObject express : expresses) {
            JSONObject nodeDefine = new JSONObject();
            nodeDefine.put(ExecuteNodeEngineConst.DEFINE_KEYWORDS_OF_UNI, "node:convert");
            nodeDefine.put("express", express);
            JsonDynamicFlowExecuteEngine executeNode = new JsonDynamicFlowExecuteEngine(nodeDefine);
    ...
    String[] buildExpected() {
        String[] expects = new String[]{
                ...
                "{\"A\":{\"A1\":1},\"B\":{\"B1\":\"1\"},\"C\":{\"C1\":[1,2]}}",
                "{\"A\":{\"A1\":1},\"B\":{\"B1\":\"1\"},\"C\":{\"C1\":[1,2]},\"D\":{\"D1\":{\"a\":1,\"b\":\"1\"}}}",
                "{\"A\":[{\"A1\":1}],\"B\":{\"B1\":\"1\"},\"C\":{\"C1\":[1,2]},\"D\":{\"D1\":{\"a\":1,\"b\":\"1\"}}}",
                "{\"A\":{\"A1\":1},\"B\":{\"B1\":\"1\"},\"C\":{\"C1\":[1,2]},\"D\":{\"D1\":{\"a\":1,\"b\":\"1\"}},\"E\":[{\"E1\":1,\"E2\":\"1\"},{\"E1\":2,\"E2\":\"2\"}]}",
                "{\"A\":{\"A1\":1},\"B\":{\"B1\":\"1\"},\"C\":{\"C1\":[1,2]},\"D\":{\"D1\":{\"a\":1,\"b\":\"1\"}},\"E\":[{\"E1\":1},{\"E1\":2}]}",
                "{\"E\":[{\"E3\":[{\"E1\":1,\"E2\":\"1\"},{\"E1\":11,\"E2\":\"11\"}]},{\"E3\":[{\"E1\":2,\"E2\":\"2\"},{\"E1\":22,\"E2\":\"22\"}]}]}",
        };
        return expects;
    }
