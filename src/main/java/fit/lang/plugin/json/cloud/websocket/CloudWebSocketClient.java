 ...
 */
public final class CloudWebSocketClient {
    Channel channel;

    public CloudWebSocketClient(String url) throws Exception {
        URI uri = new URI(url);
        ...
        try {
            ...
            CloudWebSocketClientHandler handler = new CloudWebSocketClientHandler(WebSocketClientHandshakerFactory.newHandshaker(
