...
public abstract class JsonPathLiteralValueImpl extends JsonPathValueImpl implements fit.intellij.jsonpath.psi.JsonPathLiteralValue {

  public JsonPathLiteralValueImpl(@NotNull ASTNode node) {
    super(node);
  }
