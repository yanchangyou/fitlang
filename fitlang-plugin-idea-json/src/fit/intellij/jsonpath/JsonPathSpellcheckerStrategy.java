...
import fit.intellij.jsonpath.psi.JsonPathIdSegment;
import fit.intellij.jsonpath.psi.JsonPathStringLiteral;
...
public final class JsonPathSpellcheckerStrategy extends SpellcheckingStrategy {
  ...
  private final Tokenizer<fit.intellij.jsonpath.psi.JsonPathStringLiteral> ourStringLiteralTokenizer = new Tokenizer<>() {
    @Override
    public void tokenize(@NotNull fit.intellij.jsonpath.psi.JsonPathStringLiteral element, @NotNull TokenConsumer consumer) {
  ...
  private final Tokenizer<fit.intellij.jsonpath.psi.JsonPathId> idLiteralTokenizer = new Tokenizer<>() {
    @Override
    public void tokenize(@NotNull fit.intellij.jsonpath.psi.JsonPathId element, @NotNull TokenConsumer consumer) {
      PlainTextSplitter textSplitter = PlainTextSplitter.getInstance();
      consumer.consumeToken(element, textSplitter);
    }
  };
