...
public class JsonSmartKeysConfigurable extends BeanConfigurable<fit.intellij.json.editor.JsonEditorOptions> implements UnnamedConfigurable {
  public JsonSmartKeysConfigurable() {
    super(fit.intellij.json.editor.JsonEditorOptions.getInstance());
  ...
  public JComponent createComponent() {
    ...
    assert result != null;
    result.setBorder(IdeBorderFactory.createTitledBorder("FitLang"));
    return result;
  }
}
