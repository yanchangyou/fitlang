...
public class JsonCodeStyleSettings extends CustomCodeStyleSettings {
  ...
  public enum PropertyAlignment {
    ...
    @PropertyKey(resourceBundle = fit.intellij.json.JsonBundle.BUNDLE)
    private final String myKey;
    private final int myId;

    PropertyAlignment(int id, @NotNull @PropertyKey(resourceBundle = fit.intellij.json.JsonBundle.BUNDLE) String key) {
      myKey = key;
      myId = id;
    }
