...
public class JsonStructureViewBuilderFactory implements PsiStructureViewFactory {
  ...
  public JsonStructureViewBuilderFactory() {
    fit.intellij.json.structureView.JsonCustomStructureViewFactory.EP_NAME.addChangeListener(
  ...
  public StructureViewBuilder getStructureViewBuilder(@NotNull final PsiFile psiFile) {
    ...
    List<fit.intellij.json.structureView.JsonCustomStructureViewFactory> extensionList = fit.intellij.json.structureView.JsonCustomStructureViewFactory.EP_NAME.getExtensionList();
