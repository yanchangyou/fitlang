...
public final class JsonUtil {
  ...
  @Nullable
  public static <T extends JsonElement> T getPropertyValueOfType(@NotNull final fit.intellij.json.psi.JsonObject object, @NotNull final String name,
  ...
  public static int getArrayIndexOfItem(@NotNull PsiElement e) {
    ...
    List<fit.intellij.json.psi.JsonValue> elements = ((fit.intellij.json.psi.JsonArray)parent).getValueList();
  ...
  @Contract("null -> null")
  public static @Nullable fit.intellij.json.psi.JsonObject getTopLevelObject(@Nullable fit.intellij.json.psi.JsonFile jsonFile) {
