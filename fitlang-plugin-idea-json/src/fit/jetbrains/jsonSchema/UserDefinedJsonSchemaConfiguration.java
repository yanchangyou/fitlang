...
public class UserDefinedJsonSchemaConfiguration {
  ...
  public static class Item {
    public String path;
    public fit.jetbrains.jsonSchema.JsonMappingKind mappingKind = fit.jetbrains.jsonSchema.JsonMappingKind.File;

    public Item() {
    }

    public Item(String path, fit.jetbrains.jsonSchema.JsonMappingKind mappingKind) {
    ...
    public Item(String path, boolean isPattern, boolean isDirectory) {
      this.path = neutralizePath(path);
      this.mappingKind = isPattern ? fit.jetbrains.jsonSchema.JsonMappingKind.Pattern : isDirectory ? fit.jetbrains.jsonSchema.JsonMappingKind.Directory : fit.jetbrains.jsonSchema.JsonMappingKind.File;
    }
    ...
    public boolean isPattern() {
      return mappingKind == fit.jetbrains.jsonSchema.JsonMappingKind.Pattern;
    }

    public void setPattern(boolean pattern) {
      mappingKind = pattern ? fit.jetbrains.jsonSchema.JsonMappingKind.Pattern : fit.jetbrains.jsonSchema.JsonMappingKind.File;
    }

    public boolean isDirectory() {
      return mappingKind == fit.jetbrains.jsonSchema.JsonMappingKind.Directory;
    }

    public void setDirectory(boolean directory) {
      mappingKind = directory ? fit.jetbrains.jsonSchema.JsonMappingKind.Directory : fit.jetbrains.jsonSchema.JsonMappingKind.File;
    }

    public String getPresentation() {
      if (mappingKind == fit.jetbrains.jsonSchema.JsonMappingKind.Directory && StringUtil.isEmpty(path)) {
