 ...
 */
package fit.jetbrains.jsonSchema.extension.adapters;
...
public interface JsonValueAdapter {
   ...
   */
  default fit.jetbrains.jsonSchema.impl.JsonSchemaType getAlternateType(@Nullable JsonSchemaType type) { return type; }
}
