...
public class JsonSchemaInfo {
    ...
    @Nullable
    private @Nls String myName = null;
    @Nullable
    private @Nls String myDocumentation = null;
    @NotNull
    private final static Set<String> myDumbNames = ContainerUtil.set(
            "schema",
            "lib",
            "cli",
            "packages",
    ...
    @NotNull
    private final static Map<String, @Nls String> myWeirdNames = stringMap(
    ...
    public static @NotNull Map<String, String> stringMap(@NotNull String... keyValues) {
