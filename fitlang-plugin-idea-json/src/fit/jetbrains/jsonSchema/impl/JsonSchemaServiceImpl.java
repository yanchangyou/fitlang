...
//    JsonSchemaCatalogExclusion.EP_NAME.addExtensionPointListener(this::reset, this);
  ...
  private static class MyState {
    @NotNull private final Factory<List<fit.jetbrains.jsonSchema.extension.JsonSchemaFileProvider>> myFactory;
    @NotNull private final Project myProject;
    @NotNull private final ClearableLazyValue<MultiMap<VirtualFile, fit.jetbrains.jsonSchema.extension.JsonSchemaFileProvider>> myData;
