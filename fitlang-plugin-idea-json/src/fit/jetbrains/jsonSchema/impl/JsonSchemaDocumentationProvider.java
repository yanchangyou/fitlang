...
public class JsonSchemaDocumentationProvider implements DocumentationProvider {
  ...
  public static String generateDoc(@NotNull final PsiElement element,
    ...
    for (JsonSchemaObject schema : schemas) {
      ...
      if (schema.getType() != null && schema.getType() != fit.jetbrains.jsonSchema.impl.JsonSchemaType._any) {
        ...
        final fit.jetbrains.jsonSchema.impl.JsonSchemaType guessedType = schema.guessType();
        if (guessedType != null) {
