...
public abstract class JsonSchemaInjectorBase implements MultiHostInjector {
  ...
  protected static void injectForHost(@NotNull MultiHostRegistrar registrar, @NotNull fit.intellij.json.psi.JsonStringLiteral host, @SuppressWarnings("SameParameterValue") @NotNull Language language) {
    injectForHost(registrar, host, new InjectedLanguageData(language, null, null));
  }

  protected static void injectForHost(@NotNull MultiHostRegistrar registrar, @NotNull fit.intellij.json.psi.JsonStringLiteral host, @NotNull InjectedLanguageData language) {
