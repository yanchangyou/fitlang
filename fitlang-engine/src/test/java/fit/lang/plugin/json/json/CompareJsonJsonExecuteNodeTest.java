...
//        Assert.assertEquals(9, outputJson.size());
    ...
    public void testExecute1() {
        JSONObject input = JSONObject.parseObject("{" +
                ...
                "}");
        Object expected = "{\"object.string\":{\"equal\":false,\"type\":\"REMOVE\"},\"string\":{\"equal\":false,\"type\":\"REMOVE\"},\"array[0].number\":{\"equal\":false,\"type\":\"REMOVE\"},\"array[0].string\":{\"equal\":false,\"type\":\"REMOVE\"},\"object.number\":{\"equal\":false,\"type\":\"REMOVE\"}}";
        String flow = "{" +//
                "   'uni': 'compare'," +
                "}";
        System.out.println(flow.replace("'", "\""));
