 ...
 * 执行节点
 */
public class ConvertToBasicArrayJsonExecuteNode extends JsonExecuteNode {
    ...
    public void execute(JsonExecuteNodeInput input, JsonExecuteNodeOutput output) {
        ...
        if (StrUtil.isBlank(arrayField)) {
            throw new ExecuteNodeException("convertToBasicArray arrayField field is required!");
        }
        ...
        if (list instanceof JSONArray) {
            ...
            for (Object item : array) {
                if (item instanceof JSONObject) {
                    ...
                    Object value = jsonObject.get(keyField);
                    newArray.add(value);
                }
            }
