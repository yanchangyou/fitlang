...
public class JsonPageAmisPanel extends JPanel {
    ...
    public JsonPageAmisPanel(JSONObject jsonPage, JSONObject jsonData, JSONObject option, JSONObject context) {
...
//        setSize(width, height);
    ...
    String loadHtml(String path) {
        ...
        if (html == null) {
            InputStream inputStream = JsonPageAmisPanel.class.getClassLoader().getResourceAsStream(path);
