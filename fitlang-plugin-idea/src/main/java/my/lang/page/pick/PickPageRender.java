...
public class PickPageRender implements FileEditor {

    Project project;

    PickPageRenderPanel panel;

    VirtualFile file;

    String url = "https://www.baidu.com/";

    public PickPageRender(@NotNull VirtualFile virtualFile, Project project) {
        ...
        panel = new PickPageRenderPanel(pageDefine, virtualFile, project);
    }
